...
public class AttributeStatusManager : IActorManagerInterface
{
    ...
    public bool isSkillAttack = false;//技能攻击
    public bool isAttack = false;//攻击
    public bool isNormalAttack = false;//普通
    ...
    void Update()
    {
        ...
        isNormalAttack = actorManager.ac.CheckStateByTag("attack");
        isSkillAttack =  actorManager.ac.CheckStateByTag("skill");
        isAttack = isNormalAttack || isSkillAttack;
        ...
        isStunned = actorManager.ac.CheckState("stunned");
